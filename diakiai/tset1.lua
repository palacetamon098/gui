...
local Tabs = {
    ...
    Item = Window:AddTab({ Title = "Item", Icon = "11446859498" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "11447069304" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "6031265976" }),
    Island = Window:AddTab({ Title = "Teleport", Icon = "6035190846" }),
    Raid = Window:AddTab({ Title = "Raids", Icon = "7044284832" }),
    RaceV4 = Window:AddTab({ Title = "Race Trial", Icon = "15759170666" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "130882646" }),
    ESP = Window:AddTab({ Title = "ESP", Icon = "15759111217" }),
    Misc = Window:AddTab({ Title = "Miscellaneous", Icon = "11447063791" }),
    Visual = Window:AddTab({ Title = "Visual", Icon = "15760740893" }),
    Settings = Window:AddTab({ Title = "Settings", Icon = "7040391851" }),
}

if game.CoreGui:FindFirstChild("FluentOpenClose") then
    game.CoreGui:FindFirstChild("FluentOpenClose"):Destroy()
end
...
ImageButton.Image = "rbxassetid://16096559635"
...
ImageButton.Image = "rbxassetid://15609047861"

UICorner.CornerRadius = UDim.new(0, 30)
UICorner.Parent = ImageButton

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 138)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))}
UIGradient.Parent = ImageButton
...
function GetMaterial(matname)
    ...
    Tabs.Main:AddButton({
        Title = "Join Discord - Speed X Hub",
        Description = "",
        Callback = function()
