...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Stats", Icon = "list-plus" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping-cart" }),
    Island = Window:AddTab({ Title = "Teleport", Icon = "palmtree" }),
    Raid = Window:AddTab({ Title = "Raids", Icon = "swords" }),
    RaceV4 = Window:AddTab({ Title = "Race Trial", Icon = "swords" }),
    Fruit = Window:AddTab({ Title = "Blox Fruits", Icon = "cherry" }),
    ESP = Window:AddTab({ Title = "ESP", Icon = "baby" }),
    Misc = Window:AddTab({ Title = "Miscellaneous", Icon = "list-plus" }),
    Visual = Window:AddTab({ Title = "Visual", Icon = "baby" }),
